...
class TestCore(unittest.TestCase):
    ...
    def test_regional_rules(self):
        ...
        self.assertTrue(n.dir_rule2._hasDocumentReference_RC[0].hasDocument == n.law_book_of_saxony )
        self.assertTrue(n.dir_rule2._hasDocumentReference_RC[0].hasSection == "§ 1.5")
